pipeline {
   ...
   stage('iOS Build') {
      ...
      sh 'xcodebuild  -scheme MyApp archive -archivePath platforms/ios/MyApp.xcarchive'
      sh 'xcodebuild -exportArchive -exportFormat ipa -archivePath platforms/ios/MyApp.xcarchive  -exportPath  platforms/ios/MyApp.ipa' 
